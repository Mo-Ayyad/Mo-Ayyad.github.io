var level01 = function (window) {
    ...
    window.opspark.runLevelInGame = function (game) {
        ...
        var levelData = {
            ...
            "speed": -3,
            "gameItems": [
                { type: "sawBlade", x: 400, y: groundY - 240 },
                { type: "sawBlade", x: 2100, y: groundY - 320 },
                { type: "sawBlade", x: 1000, y: groundY - 240 },
                { type: "bBall", x: 2000, y: groundY - 10 },
                { type: "bBall", x: 800, y: groundY - 120 },
                { type: "bBall", x: 1500, y: groundY - 50 },
                { type: "enemy", x: 2000, y: groundY - 10 },
                { type: "enemy", x: 800, y: groundY - 120 },
                { type: "enemy", x: 1500, y: groundY - 50 },
                { type: "reward", x: 500, y: groundY - 10 },
